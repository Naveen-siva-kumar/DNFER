...
class noisyfer:
    def __init__(self, args, train_dataset, device, input_channel, num_classes):
        ...
        self.weighted_CCE =  Sai_weighted_CCE(num_class=args.num_classes, reduction='mean')
    ...
    def train(self, train_loader, epoch):
        ...
        for i, (images1, images2, labels, indexes) in enumerate(train_loader):
            ...
            _,logits1 = self.model(images1)
            _,logits2 = self.model(images2)
            ...
            if epoch < self.warmup_epochs:               
               ...
               loss1, clean_indices1, noisy_indices1,avg1,std1 = self.weighted_CCE(logits1,labels)
               loss2, clean_indices2, noisy_indices2,avg2,std2 = self.weighted_CCE(logits2,labels)
               loss_c = (loss1 + loss2)/2.0
               
               loss_o = symmetric_kl_div(probs1, probs2).mean()
